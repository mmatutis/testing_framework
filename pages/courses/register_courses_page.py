...
class RegisterCoursesPage(BasePage):
    ...
    _nav_all_courses = 'All Courses'

    ############################
    ### Element Interactions ###
    ############################

    def navigateAndLogin(self, email, password):
        self.loginBase(email, password)

    def clickOnAllCourses(self):
        self.elementClick(locator=self._nav_all_courses, locatorType='link')
