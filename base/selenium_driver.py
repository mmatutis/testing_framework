...
class SeleniumDriver():
    ...
    def takeScreenShot(self, resultMessage):
        ...
        """
        fileName = str(round(time.time() * 1000)) + "." + resultMessage + ".png"
        screenshotDirectory = '../Screenshots/'
        realtiveFileName = screenshotDirectory + fileName
        currentDir = os.path.dirname(__file__)
        destinationFile = os.path.join(currentDir, realtiveFileName)
